    ...
    DetailedERC20
{
     ...
     * @param _initialShareRatio            How much of a Set (in gWei) equals one share
        ...
        external
    {
        ...
        remainingCurrentSets = shareRatio.mul(totalSupply_).div(10**18);
        ...
        external
    {
        ...
        // emit RebalanceFinished event
        emit RebalanceFinished(currentSet, shareRatio);
    }
    ...
    /*
     * Get shareRatio of Rebalancing Set
     *
