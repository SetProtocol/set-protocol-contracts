...
contract SetTokenRegistry is Ownable {
    ...
    modifier nameDoesNotExist(string _name) {
        require(setAddressByHashedName[keccak256(abi.encodePacked(_name))] == address(0));
        _;
    }

    modifier symbolDoesNotExist(string _symbol) {
        require(setAddressByHashedSymbol[keccak256(abi.encodePacked(_symbol))] == address(0));
        _;
    }
    ...
    */
    ...
    function getSetAddressBySymbol(
        ...
        returns(address)
    {
        return setAddressByHashedSymbol[keccak256(abi.encodePacked(_setSymbol))];
    }
    ...
    function getSetAddressByName(
        ...
        returns(address)
    {
        return setAddressByHashedName[keccak256(abi.encodePacked(_name))];
    }
    ...
    */
    ...
    function modifyAddressByName(
        ...
        returns(bool)
    {
        setAddressByHashedName[keccak256(abi.encodePacked(_name))] = _set;
        return true;
    }
    ...
    function modifyAddressBySymbol(
        ...
        returns(bool)
    {
        setAddressByHashedSymbol[keccak256(abi.encodePacked(_symbol))] = _set;
        return true;
    }
}
