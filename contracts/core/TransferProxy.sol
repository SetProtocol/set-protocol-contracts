    ...
    Authorizable
{
    ...
    function transferToVault(
        ...
        onlyAuthorized
    {
        // Retrive current balance of token for the vault
        uint exstingVaultBalance = ERC20(_tokenAddress).balanceOf(vaultAddress);
        ...
        require(newVaultBalance == exstingVaultBalance.add(_quantity));
    }
}
