...
{
    /**
     * Exposes internal function that deposits a token to the vault, to system
     * modules.
     *
     * @param  _from              Address to transfer tokens from
     * @param  _to                Address to credit for deposits
     * @param  _token             Address of the token being deposited
     * @param  _quantity          Ammount of token to deposit
     */
    ...
    /**
     * Exposes internal function that wihdraws a token from the vault, to system
     * modules.
     *
     * @param  _from              Address to withdraw tokens from
     * @param  _to                Address to withdaw to
     * @param  _token             Address of the token being withdrawn
     * @param  _quantity          Ammount of token to withdraw
     */
