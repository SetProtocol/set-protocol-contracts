...
/**
 * @title ISuspendedAuctionPriceCurve
 * @author Set Protocol
 *
 * The ISuspendedAuctionPriceCurve interface provides a structured way to interact with any AuctionLibrary
 */
interface ISuspendedAuctionPriceCurve {
    ...
    function validateAuctionPriceParameters(
        ...
        SuspendedLinearAuctionLibrary.SuspendedPriceParameters calldata _suspendedPriceParameters
    )
        external
        view;
