 ...
 */
contract OpenLinearAuctionPriceCurve {
        ...
        returns (uint256, uint256)
    {
        ...
        if (elapsed <= _auctionParameters.auctionTimeToPivot) {
            ...
            // _auctionPivotPrice
            priceNumerator = _auctionParameters.auctionStartPrice.add(
                elapsed.mul(
                    _auctionParameters.auctionPivotPrice.sub(_auctionParameters.auctionStartPrice)
