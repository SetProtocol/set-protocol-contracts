...
import { IAuctionPriceCurveV2 } from "../../lib/auction-price-libraries/IAuctionPriceCurveV2.sol";
...
library StartRebalanceLibraryV2 {
        ...
        returns (uint256)
    {
        ...
        uint256 priceDivisor = IAuctionPriceCurveV2(_auctionLibrary).priceDivisor();
