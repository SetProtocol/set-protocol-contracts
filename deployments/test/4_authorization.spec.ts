...
describe('Deployment: Authorization', () => {
  ...
  describe('Timelocks', () => {
    ...
    it('correct timelock applied to issuance order module', async () => {
  ...
  describe('Authorized Vault addresses', () => {
    ...
    it('vault contains issuance order module as an authorised address', async () => {
  ...
  describe('Authorized Transfer Proxy addresses', () => {
    ...
    it('transfer proxy contains taker wallet wrapper as an authorised address', async () => {
