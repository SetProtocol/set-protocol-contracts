...
contract('RebalancingSetTokenV3Factory', accounts => {
  const [
    deployerAccount,
  ...
  const rebalanceHelper = new RebalancingSetV3Helper(deployerAccount, coreHelper, erc20Helper, blockchain);
  ...
  describe('#constructor', async () => {
    ...
    async function subject(): Promise<RebalancingSetTokenV3FactoryContract> {
      return await coreHelper.deployRebalancingSetTokenV3FactoryAsync(
        subjectCoreAddress,
  ...
  describe('#create from core', async () => {
    ...
    beforeEach(async () => {
      rebalancingSetTokenFactory = await coreHelper.deployRebalancingSetTokenV3FactoryAsync(
        core.address,
    ...
    async function subject(): Promise<RebalancingSetTokenV3Contract> {
      return await rebalanceHelper.createRebalancingTokenV3Async(
        core,
