...
const STBTCDAI_BTD_CONFIG = DEPLOYED_SETS_INFO.BTCDAI_SHORT_TERM_BTD;
const STETHDAI_BTD_CONFIG = DEPLOYED_SETS_INFO.ETHDAI_SHORT_TERM_BTD;
...
export const SHORT_TERM_BTCDAI_BTD: AssetScenario  = {
  scenarioCount: 8,
  assetOne: DEPENDENCY.WBTC,
  assetTwo: DEPENDENCY.DAI,
  assetOneMedianizer: DEPENDENCY.WBTC_MEDIANIZER,
  assetTwoMedianizer: undefined,
  rebalancingSetName: STBTCDAI_BTD_CONFIG.SET_NAME,
  collateralSetName: STBTCDAI_BTD_CONFIG.COLLATERAL_NAME,
  managerName: STBTCDAI_BTD_CONFIG.MANAGER_NAME,
  issuerAccounts: [1, 2],
  bidderAccounts: [3, 4],
  managerConfig: {
    pricePrecision: STBTCDAI_BTD_CONFIG.PRICE_PRECISION,
    assetOneMultiplier: STBTCDAI_BTD_CONFIG.WBTC_MULTIPLIER,
    assetTwoMultiplier: STBTCDAI_BTD_CONFIG.DAI_MULTIPLIER,
    lowerAllocationBound: new BigNumber(STBTCDAI_BTD_CONFIG.ALLOCATION_LOWER_BOUND.production),
    upperAllocationBound: new BigNumber(STBTCDAI_BTD_CONFIG.ALLOCATION_UPPER_BOUND.production),
    auctionTimeToPivot: new BigNumber(STBTCDAI_BTD_CONFIG.AUCTION_TIME_TO_PIVOT.production),
  },
  rebalancingSetConfig: {
    naturalUnit: CONSTANTS.DEFAULT_REBALANCING_NATURAL_UNIT,
    rebalanceInterval: CONSTANTS.THIRTY_DAYS_IN_SECONDS,
...
export const SHORT_TERM_ETHDAI_BTD: AssetScenario  = {
  scenarioCount: 8,
  assetOne: DEPENDENCY.WETH,
  assetTwo: DEPENDENCY.DAI,
  assetOneMedianizer: DEPENDENCY.WETH_MEDIANIZER,
  assetTwoMedianizer: undefined,
  rebalancingSetName: STETHDAI_BTD_CONFIG.SET_NAME,
  collateralSetName: STETHDAI_BTD_CONFIG.COLLATERAL_NAME,
  managerName: STETHDAI_BTD_CONFIG.MANAGER_NAME,
  issuerAccounts: [1, 2],
  bidderAccounts: [3, 4],
  managerConfig: {
    pricePrecision: STETHDAI_BTD_CONFIG.PRICE_PRECISION,
    assetOneMultiplier: STETHDAI_BTD_CONFIG.WETH_MULTIPLIER,
    assetTwoMultiplier: STETHDAI_BTD_CONFIG.DAI_MULTIPLIER,
    lowerAllocationBound: new BigNumber(STETHDAI_BTD_CONFIG.ALLOCATION_LOWER_BOUND.production),
    upperAllocationBound: new BigNumber(STETHDAI_BTD_CONFIG.ALLOCATION_UPPER_BOUND.production),
    auctionTimeToPivot: new BigNumber(STETHDAI_BTD_CONFIG.AUCTION_TIME_TO_PIVOT.production),
  },
  rebalancingSetConfig: {
    naturalUnit: CONSTANTS.DEFAULT_REBALANCING_NATURAL_UNIT,
    rebalanceInterval: CONSTANTS.THIRTY_DAYS_IN_SECONDS,
